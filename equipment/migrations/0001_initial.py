    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
                ('embossment_id', models.CharField(max_length=100, unique=True)),
                ('operational_status', models.CharField(choices=[('functional', 'Functional'), ('under_maintenance', 'Under Maintenance'), ('decommissioned', 'Decommissioned')], default='functional', max_length=20)),
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='equipment', to='equipment.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pre_status', models.CharField(blank=True, choices=[('functional', 'Functional'), ('under_maintenance', 'Under Maintenance'), ('decommissioned', 'Decommissioned')], max_length=30, null=True)),
                ('post_status', models.CharField(blank=True, choices=[('functional', 'Functional'), ('under_maintenance', 'Under Maintenance'), ('decommissioned', 'Decommissioned')], max_length=30, null=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['name', 'department', 'operational_status'], name='equipment_e_name_940b15_idx'),
        ),
        migrations.AddIndex(
            model_name='equipment',
            index=models.Index(fields=['embossment_id'], name='equipment_e_embossm_98fb99_idx'),
        ),
    ]
